for(i=1; i<13; i++){
 ...
 reelsBox.innerHTML = `
  <div class="reels_img">
      ...
      <div class="reels_txt">
       <div class="reels_id">
        <img src="./img/story_img${i}.JPG" alt="x"><p>Instar_ID${i} · </p>
        <span>팔로우</span>
       </div>
       <!-- reels_id end -->
     ...
     <div class="reels_icon">
      <div class="icon">
       <ul>
        ...
        <li><img id="hate" src="./img/hate.png" alt="x">
        <p id="likeNum">0</p></li>
        <li><img src="./img/comment.png" alt="x">
         <p id="commentNum">0</p>
        </li>
        <li><img src="./img/dm.png" alt="x"></li>
        <li><img id="scrap" src="./img/scrap.png" alt="x">
            <img id="save" src="./img/save.png" alt="x"></li>
        <li><span>···</span></li>
